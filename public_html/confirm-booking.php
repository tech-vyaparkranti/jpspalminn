    ...
    <div class="row">
        <div class="col-md-8 card-form">
           <h2 class="section-heading">
                        ...
                        </h2> <hr><div class="divider-l"></div>
               <div id="contact-form">
                                    <form  id="form" method="post" name="send">
                                        <!-- col start -->
			 ...
			 <option value="">--Select--</option>    
			  ...
			  <option value="SR">Sr.</option>
                                        ...
                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                            ...
                                            <input class="requiredField name" name="first_name" placeholder="First Name" type="text">
                                        </div>
                                        <!-- col end -->
                                        <!-- col start -->
                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                          <input class="requiredField name"  name="last_name" placeholder="Last Name" type="text">
                                        </div>
                                        <!-- col end -->
                                        <!-- col start -->
		...
		<option value="+383|Kosovo">Kosovo (+383)</option> <!--Prashant - 12/08/2021 - purpose: change country code [RES-2866] -->
		...
		<option value="+886|Taiwan">Taiwan (+886)</option> <!--Parth - 30 Apr 2019 - RES-1963 - Add Taiwan Country code.-->
		...
		<option value="+263|Zimbabwe">Zimbabwe (+263)</option>
                                            ...
                                            <input class="requiredField mobile"  name="mobile" placeholder="Mobile Number" type="number">
                                        </div>  
                                        
                                        <div class="col-sm-12 col-md-12 col-lg-12">
                                               <input class="requiredField email"  name="email" placeholder="Email" type="text">
                                               </div>
				...
				<h4>Hotel Policy &amp; Booking Conditions</h4>
										<p>Hotel Policy</p><hr>
						<div>
							 <p>Account Details:<br>JPS Palm Inn,<br>State Bank of India,<br>Account No. - 35818000649,<br>IFSC - SBIN0011852,<br>Branch - Kullu (H.P)</p>
					</div><div class="divider-l"></div>
													 <p>Cancellation Policy</p><hr>
					 <div>
						  <p>CANCELLATION POLICY:<br><br>(A)    Booking cancelled in the last 96 hrs to 72hrs from the date of arrival will  will carry a 1 night retention charge.<br><br>(B)    Booking cancelled in the last 72 hrs to 24hrs from the date of arrival will carry a 50% retention charge.<br><br>(C)    Booking cancelled in the last 24hrs from the date of arrival will carry a 100% retention charge.<br><br>(d)    We do not accept Cancellations over Phone ;Cancellations can be done on any working day between 10:00 hrs  to  18:30 hrs from Monday to Saturday by Email.<br><br>NO-SHOW POLICY<br>(a)    A no-show will carry a 100% retention charge.</p>
					 </div>
        ...
        <div class="col-md-4 card1">
            ...
            <div class="card-body">
               <h4>JPS Palm Inn</h4><hr>
                <p class="pereq">Plot no-14, Sector-8 Road, Imt Manesar, Gurugram, Haryana (122051), India.</p><hr>
               <p class="pereq"><i class="fa fa-phone"></i> 7836950747  </p><hr>
                <p class="pereq"><i class="fa fa-envelope"></i>   jpspalminn@gmail.com </p><hr>
